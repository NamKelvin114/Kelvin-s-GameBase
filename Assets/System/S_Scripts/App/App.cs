...
namespace Kelvin
{
    public struct App
    {
        ...
        {
            if (!Data.HasKey(Invariant.FIRST_OPEN_TIMESTAMP_KEY))
        ...
        {
            globalComponent.CancelAllDelayHandle();
        }

        public static void PauseAllDelay()
        {
            globalComponent.PauseAllDelayHandle();
        }

        public static void ResumeAllDelay()
        {
            globalComponent.ResumeAllDelayHandle();
        }
    }
}