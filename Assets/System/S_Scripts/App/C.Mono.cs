...
namespace Kelvin
{
    public static class C
    {
        ...
        {
#if UNITY_EDITOR
            Undo.RecordObject(transform, "Transform RemoveAllChildren");
#endif
        ...
        ///     Negative value means no limit, zero means root only, positive value means maximum children
        ///     depth
        /// </param>
        public static void TraverseHierarchy(this Transform root, Action<Transform> operate, int depthLimit = -1)
        {
            ...
            if (depthLimit != 0)
            {
                ...
                for (var i = 0; i < count; i++) TraverseHierarchy(root.GetChild(i), operate, depthLimit - 1);
            }
        }
        ...
        public static void InverseTraverseHierarchy(this Transform root, Action<Transform> operate, int depthLimit = -1)
        {
            ...
            {
                var count = root.childCount;
                for (var i = 0; i < count; i++) InverseTraverseHierarchy(root.GetChild(i), operate, depthLimit - 1);
            }
        ...
        public static void ManualUpdate(this ContentSizeFitter fitter)
        {
