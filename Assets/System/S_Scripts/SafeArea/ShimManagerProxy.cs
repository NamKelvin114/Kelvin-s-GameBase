...
namespace Kelvin.SafeAreEditor
{
    internal static class ShimManagerProxy
    {
        ...
        private static readonly Type ShimManagerType =
            Assembly.Load("UnityEngine.dll").GetType("UnityEngine.ShimManager");
        ...
        public static int Width
        {
            get
            {
                ...
                return activeScreenShim.GetType().GetProperty(WIDTH_KEY)?.GetValue(activeScreenShim) as int? ??
                       Screen.width;
            }
        }
        ...
        public static int Height
        {
            get
            {
                ...
                return activeScreenShim.GetType().GetProperty(HEIGHT_KEY)?.GetValue(activeScreenShim) as int? ??
                       Screen.height;
            }
        }
    }
