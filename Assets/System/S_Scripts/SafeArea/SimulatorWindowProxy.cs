...
namespace Kelvin.SafeAreEditor
{
    public static class SimulatorWindowProxy
    {
...
#if !UNITY_2021_1
            RepaintImmediatelyMethodInfo = typeof(EditorWindow).GetMethod("RepaintImmediately",
        ...
        public static bool hasFocus => (isOpen && EditorWindow.focusedWindow &&
                                        (EditorWindow.focusedWindow.GetType() == SimulatorWindow));
